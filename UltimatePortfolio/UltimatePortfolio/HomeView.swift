...
struct HomeView: View {
    ...
    init() {
        ...
        request.sortDescriptors = [NSSortDescriptor(keyPath: \Item.project, ascending: false)]
                    ...
                    ScrollView(.horizontal, showsIndicators: false){
                        LazyHGrid(rows: projectRows) {
                            ForEach(projects){ project in
                                ...
                                .accessibilityLabel("\(project.projectTitle), \(project.projectItems.count) items, \(project.completionAmmount*100, specifier: "%g")% complete.")
                            }
                        }
